...
<body>
    ...
    <main>
        <h1>JSP Action Tag</h1>
            <%--
            JSP 액션 태그: 스크립트릿에서 사용되는 일부 자바 코드들을 
            HTML 또는 XML과 비슷하게 태그, 태그 속성(attribute),태그 컨텐트를 작성해서 대체하는 문법.  
            JSP Action Tag는 대/소문자를 구분한다. (HTML 태그는 대/소문자를 구분하지 않는다.)
                - <jsp:forward></jsp:forward>
                - <jsp:include></jsp:include>
                - <jsp:useBean></jsp:useBean>: 생성자 호출
                - <jsp:getProperty></jsp:getProperty>: getter 메서드 호출
                - <jsp:setProperty></jsp:setProperty>: setter 메서드 호출
            --%>
        ...
        <h2>액션태그 자바 빈을 사용한 객체 생성</h2>
            ...
            --> 액션태그를 사용할 때에는 기본생성자가 반드시 필요하다. --%> 
            
            <jsp:setProperty property="id" name="contact2" value="2" />
            <%-- contact2.setId(2); --%>
            
            <jsp:setProperty property="name" name="contact2" value="지현" />
            <jsp:setProperty property="phone" name="contact2" value="010-2332-7575" />
            <jsp:setProperty property="email" name="contact2" value="hylz@google.com" />
    ...
    <jsp:include page="footer.jsp" />
        <%-- 
            <%@ include file="" %>와 비슷하지만, JSP 파일들이 각각 컴파일 된 후 합쳐진다. 
            따라서 '.jspf'는 사용하지 않고, '.jsp'만 사용한다.  
        --%>
