...
//	@Test
	public void testDependencyInjection() {
		// EmployeeRepository 객체를 의존성 주입 받을 수 있는지 테스트.
		 ...
		 *             |__ SimpleJpaRepository<T, ID> --> '실제로 생성된 객체'
		 */	
	}
...
//	@Test
	...
	@Transactional // fetch 타입에 필요.
	@Test
	public void testFindById() {
		// 1. EmployeeRepository.findById() 메서드 테스트
		// 2. Employees 테이블과 Jobs 테이블 간의 관계 테스트(JOB_ID - JOB_ID)
		// 3. Employees 테이블과 Employees 테이블 간의 관계 테스트(MANAGER_ID - EMPLOYEE_ID) 
